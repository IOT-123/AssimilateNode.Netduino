...
namespace AssimilateNode.Networking
{
    public static class Initializer
    {
        ...
        /// <summary>
        /// Delegate for NetworkConnected
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void NetworkConnectedDelegate(object sender, EventArgs e);
        /// <summary>
        /// Event on network connected
        /// </summary>
        public static event NetworkConnectedDelegate NetworkConnected;

        /// <summary>
        /// Delegate for NetworkTimeout
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void NetworkTimeoutDelegate(object sender, EventArgs e);
        /// <summary>
        /// Event on network timeout
        /// </summary>
        public static event NetworkTimeoutDelegate NetworkTimeout;
        #endregion
            ...
            if (networkInterface.IPAddress == IPAddress.Any.ToString())
            {
                ...
                if (networkInterface.IsDhcpEnabled)
                {
                    ...
                    if (networkInterface.IPAddress == IPAddress.Any.ToString())
                    {
                        ...
                        NetworkTimeout?.Invoke(null, EventArgs.Empty);
                        return false;
                    }
